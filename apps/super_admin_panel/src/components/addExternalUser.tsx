...
import { ExternalUser, ExternalUserFormData, availableExternalUserRoles, availableStatusOptions } from '../lib/supabaseUsers';
      ...
      >
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-2xl">
          <div>
            ...
            <p id="modal-description" className="text-sm text-gray-600 mt-1">
              {mode === 'edit' ? 'Update user information' : 'Enter user details to create a new account'}
            </p>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 space-y-5 max-h-96 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              } rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-gray-500 text-gray-900`}
            />
            {errors.name && (
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className={`w-full px-4 py-3 border-2 ${
                errors.business ? 'border-red-300 bg-red-50' : 'border-gray-200'
              } rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-gray-500 text-gray-900`}
            />
            {errors.business && (
              <p className="text-sm text-red-600 flex items-center gap-1">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder:text-gray-500 text-gray-900"
            />
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative z-10">
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white appearance-none cursor-pointer text-gray-900 hover:border-gray-300"
                >
                  {availableExternalUserRoles.map((role) => (
        ...
        <div className="flex gap-3 p-6 pt-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
          ...
          <button
            ...
            className="flex-1 py-3 px-6 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
